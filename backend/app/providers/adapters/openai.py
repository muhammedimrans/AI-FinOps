"""OpenAI provider adapter stub — EP-06."""
...
class OpenAIProvider(AIProvider):
    ...
    async def verify_auth(self) -> bool:
        raise NotImplementedError("OpenAI auth verification is implemented in EP-07")

    async def check_capability(self, capability: str) -> bool:
        raise NotImplementedError("OpenAI capability check is implemented in EP-07")
    ...
    async def complete(self, request: ProviderRequest) -> ProviderResponse:
        raise NotImplementedError("OpenAI completion is implemented in EP-07")
