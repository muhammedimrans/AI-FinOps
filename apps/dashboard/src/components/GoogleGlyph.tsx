// The official Google "G" mark — EP-24.5, shared by Login.tsx and Settings.tsx
// (Continue with Google / linked-accounts badge) so there is exactly one copy.
export default function GoogleGlyph({ className = "h-4 w-4" }: { className?: string }) {
  return (
